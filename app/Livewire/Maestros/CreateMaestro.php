...
class CreateMaestro extends Component
{
    ...
    public function messages()
    {
        return [
            ...
            'model.nombre.regex' =>'El campo debe ser llenado con caracteres alfabéticos',
            ...
            'mode.apellido.regex' =>'El campo debe ser llenado con caracteres alfabéticos',
    ...
    {
        $this->cargarForm();
        return view('livewire.maestros.create-maestro');
    }
